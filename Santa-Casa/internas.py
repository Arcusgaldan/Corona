...
def acharId(Cpf, Cns, Nome, Dn, tabela):
    ...
    if(type(Nome) is float):
        print("Achei um nome float: " + str(Nome) + "\nCPF: " + str(Cpf) + "\n CNS: " + str(Cns) + "\nData Nasc: " + str(Dn))
        Nome = None
...
def limpaUtf8(tabela): #Função que limpa os caracteres bugados do UTF-8 do arquivo de exportação do eSUS
    ...
    tabela.rename(columns={"Data da NotificaÃ§Ã£o": "Data da NotificaCAo", "Resultado (PCR/RÃ¡pidos)": "Resultado (PCR/RApidos)", "MunicÃ­pio de ResidÃªncia": "MunicIpio de ResidEncia", "Data do inÃ­cio dos sintomas": "Data do inIcio dos sintomas", "MunicÃ­pio de ResidÃªncia": "MunicIpio de ResidEncia"}, inplace=True)
    return tabela
...
paramDiasNegativo = 10 #Parâmetro que define quantos dias atrás uma notificacao de negativo deve ser considerada "a mesma" notificacao. Acima desse parâmetro deve ser considerada uma nova notificacao
...
filtroTotal1 = tabelaTotalEsus['Notificante CNES'] == 2035731
filtroTotal2 = tabelaTotalEsus['Notificante CNES'] == 2048736
filtroTotal3 = tabelaTotalEsus['Notificante CNES'] == 2048744
filtroTotal4 = tabelaTotalEsus['Notificante CNES'] == 2053314
filtroTotal5 = tabelaTotalEsus['Notificante CNES'] == 2056062
filtroTotal6 = tabelaTotalEsus['Notificante CNES'] == 2061473
filtroTotal7 = tabelaTotalEsus['Notificante CNES'] == 2064081
filtroTotal8 = tabelaTotalEsus['Notificante CNES'] == 2064103
filtroTotal9 = tabelaTotalEsus['Notificante CNES'] == 2093642
filtroTotal10 = tabelaTotalEsus['Notificante CNES'] == 2093650
filtroTotal11 = tabelaTotalEsus['Notificante CNES'] == 2784572
filtroTotal12 = tabelaTotalEsus['Notificante CNES'] == 2784580
filtroTotal13 = tabelaTotalEsus['Notificante CNES'] == 2784599
filtroTotal14 = tabelaTotalEsus['Notificante CNES'] == 5562333
filtroTotal15 = tabelaTotalEsus['Notificante CNES'] == 7035861
filtroTotal16 = tabelaTotalEsus['Notificante CNES'] == 7122217
filtroTotal17 = tabelaTotalEsus['Notificante CNES'] == 7565577
filtroTotal18 = tabelaTotalEsus['Notificante CNES'] == 7585020
filtroTotal19 = tabelaTotalEsus['Notificante CNES'] == 2053306
filtroTotal20 = tabelaTotalEsus['Notificante Email'] == "machado.vl@bol.com.br"
filtroTotal21 = tabelaTotalEsus['Notificante Email'] == "marcioli@bol.com.br"
filtroTotal22 = tabelaTotalEsus['Notificante Email'] == "marcosnascimento32@outlook.com"
filtroResidencia = tabelaTotalEsus['MunicIpio de ResidEncia'] == "Barretos"

tabelaTotalStc = tabelaTotalEsus.where(filtroResidencia & (filtroTotal1 | filtroTotal2 | filtroTotal3 | filtroTotal4 | filtroTotal5 | filtroTotal6 | filtroTotal7 | filtroTotal8 | filtroTotal9 | filtroTotal10 | filtroTotal11 | filtroTotal12 | filtroTotal13 | filtroTotal14 | filtroTotal15 | filtroTotal16 | filtroTotal17 | filtroTotal18 | filtroTotal19 | filtroTotal20 | filtroTotal21 | filtroTotal22))
...
tabelaTotalAssessor = pd.read_excel("lista total assessor.xlsx", dtype={'CPF': np.unicode_, 'CNS': np.unicode_}).sort_values(by=["Cód. Paciente", "Data da Notificação"])
...
for row in tabelaNegativosStc.itertuples():
    ...
    if not "SUSPEITA" in notifAssessor["SituaCAo"].values:
        tabelaNegativosStcFalso.append({"Nome": row[paramColunaNomeEsus], "CPF": row.CPF, "Motivo": "Sem suspeita para fechar"})
...
with pd.ExcelWriter('Internas ' + paramDataAtual.strftime("%d.%m") + '.xlsx') as writerStcCorreto:
