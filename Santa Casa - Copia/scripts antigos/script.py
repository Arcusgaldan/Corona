...
tabelaTotalStc = tabelaTotalEsus.where(tabelaTotalEsus['Notificante CNES'] == 2092611).dropna(how='all')
tabelaTotalPio = tabelaTotalEsus.where(tabelaTotalEsus['Notificante CNES'] == 2090236).dropna(how='all')
